...
resource "azurerm_postgresql_flexible_server" "first" {
  ...
  location                      = <region>
  create_mode                   = "Replica"
  source_server_id              = "/subscriptions/<subscriptionid>/resourceGroups/<resource-group-name>/providers/Microsoft.DBforPostgreSQL/flexibleServers/<source-server-name>"
  version                       = "16"
